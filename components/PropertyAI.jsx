...
const SYSTEM_PROMPT = `You are Property AI, the digital concierge for S.I.P Mohali — a trusted real estate agency in the Mohali tri-city (Mohali, Chandigarh, Zirakpur, Kharar, New Chandigarh).

Firm facts:
- Firm: S.I.P Mohali
- Office: Sector 61 / Phase 7, Sector 79, Sahibzada Ajit Singh Nagar, Punjab 140308
...
function PropertyAI({ onSchedule }) {
  ...
  const send = async (text) => {
    ...
    try {
      ...
      setMessages((m) => [...m, { role: "assistant", content: "I can't reach my brain right now. Please call the desk on +91 98765 00002 — they'll be happy to help." }]);
    } finally {
      setSending(false);
    }
  };
